  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="stagger-media lg:col-span-6 relative group overflow-hidden shadow-2xl bg-black/40 macro-lens-element transition-transform duration-300">
        ...
        <div className="lg:col-span-6 flex flex-col items-start justify-center parallax-text-group">
          ...
          <div className="stagger-desc w-full grid grid-cols-3 gap-4 mb-8 pt-4 border-t border-white/10">
